...
const Hero = () => {
  ...
  return (
    <div className='relative'>
      <div className='h-[600px] sm:h-[600px] shadow shadow-xl flex items-center bg-white-800 pt-6'>
      ...
      <div className='absolute left-0 right-0 hidden md:flex md:-bottom-12 sm:-bottom-8 mx-4 sm:mx-auto sm:max-w-screen-md md:max-w-screen-lg bg-slate-300 text-black border rounded-md dark:text-white-70 shadow-lg py-4'>
